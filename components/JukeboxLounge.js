...
export default function JukeboxLounge() {
  return (
    ...
    >
      ...
      <div className="w-full p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 backdrop-blur-sm shadow-md flex items-center gap-4">
        <div className="w-14 h-14 rounded-xl bg-zinc-950 border border-zinc-850 flex items-center justify-center text-amber-400 shadow-inner flex-shrink-0">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <ScrollReveal className="col-span-1 md:col-span-8 w-full">
          ...
          <div className="relative w-full rounded-2xl bg-zinc-950 border-2 border-zinc-800 p-6 sm:p-8 flex flex-col gap-6 shadow-2xl overflow-hidden min-h-[420px]">
            ...
            <div className="absolute top-0 bottom-0 left-0 w-1 bg-amber-400 opacity-70 shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
            <div className="absolute top-0 bottom-0 right-0 w-1 bg-amber-400 opacity-70 shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
            
            {/* Top Lightup Sign */}
            <div className="w-full py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg flex items-center justify-center shadow-inner relative overflow-hidden select-none">
              <div className="absolute inset-0 bg-amber-400/5 filter blur-sm animate-pulse" />
              <span className="text-sm font-extrabold font-mono tracking-[0.3em] text-amber-400 uppercase glow-text-amber flex items-center gap-2">
                <Radio className="w-4.5 h-4.5" /> SELECT-A-TRACK JUKEBOX
              </span>
            </div>

            {/* Inactive Jukebox Main Display Screen */}
            <div className="flex-1 rounded-xl bg-zinc-900/60 border border-zinc-800 p-6 flex flex-col items-center justify-center text-center relative overflow-hidden">
              ...
              <h3 className="text-base font-extrabold text-white font-mono uppercase tracking-wider mb-2">
                Jukebox Offline // Awaiting Ingestion
              </h3>
              <p className="text-sm text-zinc-300 max-w-[350px] leading-relaxed mb-6 font-medium">
              ...
              <div className="w-full max-w-[350px] flex flex-col gap-2.5 opacity-40 select-none">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="flex items-center justify-between p-2 rounded bg-zinc-950 border border-zinc-900 text-xs font-mono">
                    <span className="text-amber-400 font-bold">A-{10 + i}</span>
        ...
        <ScrollReveal delay={0.15} className="col-span-1 md:col-span-4 w-full">
          <div className="flex flex-col gap-6 w-full">
            ...
            <div className="w-full p-5 rounded-2xl bg-zinc-950 border border-zinc-800 flex flex-col gap-4 shadow-xl">
              <h3 className="text-xs font-black font-mono uppercase tracking-widest text-amber-400 border-b border-zinc-900 pb-2">
                Streaming Hubs
              </h3>

              {/* Spotify Platform Link */}
              <div className="w-full p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 hover:border-emerald-500/40 flex items-center justify-between group cursor-not-allowed opacity-75 transition-all">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-zinc-950 flex items-center justify-center text-emerald-550 shadow-inner group-hover:text-emerald-400">
                    {/* Inline Spotify SVG */}
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-bold text-white">Spotify Profile</span>
                    <span className="text-xs text-zinc-300 font-mono font-medium">Offline / Ingesting</span>
                  </div>
                </div>
              ...
              <div className="w-full p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 hover:border-rose-500/40 flex items-center justify-between group cursor-not-allowed opacity-75 transition-all">
                <div className="flex items-center gap-3">
            ...
            <div className="w-full p-5 rounded-2xl bg-zinc-950 border border-zinc-800 flex flex-col items-center gap-3 shadow-xl relative overflow-hidden text-center">
              ...
              <p className="text-xs text-zinc-200 leading-relaxed font-semibold font-mono">
