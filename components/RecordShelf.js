            ...
            <div className="flex items-end gap-3 sm:gap-4 md:gap-5 h-full overflow-visible z-10">
              {records.map((record) => {
                ...
                return (
                  <motion.div
                    key={record.id}
                    className="relative cursor-pointer select-none group h-60 flex flex-col items-end overflow-visible"
                    style={{ width: "3.2rem" }}
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      variants={{
                        ...
                        hover: { y: -65, opacity: 1, scale: 1, transition: { type: "spring", stiffness: 300, damping: 18 } },
                        active: { y: -65, opacity: 1, scale: 1 }
                      }}
                    >
                    ...
                    <motion.div
                      ...
                      variants={{
                        ...
                        hover: { y: -20, scale: 1.05, rotate: -1, transition: { type: "spring", stiffness: 350, damping: 20 } },
                        active: { y: -10, scale: 1.02, rotate: 0, boxShadow: "0 0 15px rgba(245, 158, 11, 0.4)" }
                      }}
                    >
                    ...
                    <motion.div 
                      ...
                      variants={{
                        rest: { opacity: 0.8, scaleX: 1 },
                        hover: { opacity: 0.3, scaleX: 0.8 },
                        active: { opacity: 0.5, scaleX: 0.9 }
                      }}
                    />
                    ...
                    <motion.div
                      ...
                      variants={{
                        rest: { opacity: 0, scale: 0.8, y: 10, display: "none" },
                        hover: { opacity: 1, scale: 1, y: 0, display: "flex", transition: { delay: 0.15 } },
                        active: { opacity: 0, scale: 0.8, y: 10, display: "none" }
                      }}
                    >
